    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg dark:bg-gray-800">
                ...
                <div class="bg-gradient-to-br from-white via-cyan-50/30 to-teal-50/50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-2xl p-8 mb-8 border border-cyan-200/50 dark:border-gray-700/50 shadow-xl overflow-hidden">
                    <!-- Decorative background elements -->
                    <div class="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-cyan-400/10 to-teal-500/10 rounded-full -translate-y-20 translate-x-20"></div>
                    <div class="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-emerald-400/10 to-green-500/10 rounded-full translate-y-16 -translate-x-16"></div>
                    ...
                    <div class="relative z-10">
                        ...
                        <!-- Informations regroupées dans un seul bloc -->
                        <div class="bg-gradient-to-br from-white to-cyan-50/50 dark:from-gray-700 dark:to-gray-800 p-8 rounded-2xl border border-cyan-200/50 dark:border-gray-600/50 shadow-lg">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <!-- Type de congé -->
                                <div class="flex items-center">
                                    <div class="bg-gradient-to-r from-cyan-500 to-cyan-600 p-3 rounded-xl shadow-lg mr-4">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-cyan-700 dark:text-cyan-300 mb-2">Type de congé</h3>
                                        <x-leave-type-badge :type="$leave->type" style="gradient" />
                                    </div>
                                </div>

                                <!-- Période -->
                                <div class="flex items-center">
                                    <div class="bg-gradient-to-r from-teal-500 to-teal-600 p-3 rounded-xl shadow-lg mr-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-white">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="text-sm font-medium text-teal-700 dark:text-teal-300 mb-2">Période</h3>
                                ...
                                <!-- Demandeur -->
                                <div class="flex items-center">
                                    <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 p-3 rounded-xl shadow-lg mr-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-white">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="text-sm font-medium text-emerald-700 dark:text-emerald-300 mb-2">Demandeur</h3>
                                ...
                                <!-- Département -->
                                <div class="flex items-center">
                                    <div class="bg-gradient-to-r from-green-500 to-green-600 p-3 rounded-xl shadow-lg mr-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-white">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-medium text-green-700 dark:text-green-300 mb-2">Département</h3>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-cyan-700 dark:text-cyan-300 mb-2">Statut</h3>
                                        @switch($leave->status)
                                            @case('pending')
                                                <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-yellow-500 to-orange-500 text-white shadow-lg">
                                                ...
                                                @break
                                            @case('approved')
                                                <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-green-500 to-emerald-500 text-white shadow-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 mr-2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    </svg>
                                                    Approuvé
                                                ...
                                                @break
                                            @case('rejected')
                                                <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 mr-2">
                                ...
                                <div class="col-span-1 lg:col-span-2">
                                    <div class="flex items-start">
                                        <div class="bg-gradient-to-r from-teal-500 to-teal-600 p-3 rounded-xl shadow-lg mr-4 mt-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-white">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                                            </svg>
                                        </div>
                                        <div class="flex-1">
                                            <h3 class="text-sm font-medium text-teal-700 dark:text-teal-300 mb-2">Motif de la demande</h3>

...
>
    ...
    <div class="nav-wrapper mb-[36px] pr-[50px]">
        ...
        <ul class="mt-2.5">
            ...
            <!-- paie -->
            <li class="item py-[11px] text-bgray-900 dark:text-white hover:text-succes-400">
                <a href="#" @click.prevent="toggleSubmenu('payroll')">
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2.5">
                        <span class="item-ico">
                        <svg
                ...
                <ul
                    class="sub-menu ml-2.5 mt-[22px] border-l border-success-100 pl-5"
                    :class="{ 'active': isSubmenuOpen('payroll') }"
                    x-show="isSubmenuOpen('payroll')"
                    x-transition
                >
                    <li>
                    <a
                        href="{{ route('payslips.index') }}" 
                        class="sidebar-sublink  {{ request()->routeIs('payslips.*') ? 'active' : '' }} text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300"
                        >Bulletins de paie</a
                    >
                    </li>
                    <li>
                    ...
                    <li>
                         @if (auth()->user()->hasAdminAccess())
                            <a
                                href="{{ route('admin.payroll-settings.index') }}"
                                class="sidebar-sublink {{ request()->routeIs('admin.payroll-settings.*') ? 'active' : '' }} text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300"
                                >Paramètres de paie</a>
                        @endif
                    </li>
    ...
    <div class="upgrade-wrapper mb-[26px] h-[172px] w-full pr-[24px]">
        ...
        style="background-image: url({{ asset('images/bg/upgrade-bg.png') }}) "
        >
        <div
...
<aside class="relative hidden w-[96px] bg-white dark:bg-black sm:block" x-data="{
        openMenus: {},
        init() {
            // Initialize the component
        },
    ...
    <div class="sidebar-body w-full pt-[14px]">
        ...
        <div class="nav-wrapper mb-[36px]">
            ...
            >
                ...
                <a href="javascript:void(0)" @click.prevent="toggleSubmenu('dashboard-mini')">
                    <span class="item-ico">
                    <svg
                        width="18"
                        height="21"
                ...
                <ul
                    ...
                    x-show="isSubmenuOpen('dashboard-mini')"
                    x-transition
                >
                    <li>
                    <a
                ...
                <li class="item px-[43px] py-[11px]">
                <a href="javascript:void(0)" @click.prevent="toggleSubmenu('statistics')">
                    <span class="item-ico">
                    <svg
                        width="20"
                        height="20"
                ...
                <ul
                    class="sub-menu min-w-[200px] rounded-lg border-l border-success-100 bg-white px-5 py-2 shadow-lg"
                    x-show="isSubmenuOpen('statistics')"
                    x-transition
                >
                    <li>
                    <a
            ...
            >
                <li class="item px-[43px] py-[11px]">
                <a href="javascript:void(0)" @click.prevent="toggleSubmenu('support')">
                    <span class="item-ico">
                    <svg
                        width="20"
                        height="18"

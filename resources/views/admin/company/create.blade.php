        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-green-400 via-teal-500 to-lime-300 rounded-xl p-6 mb-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-blue-100">Configurez les informations de base de votre entreprise</p>
                        </div>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden">
                <div class="p-8">
                    ...
                    @endif
                    <form action="{{ route('admin.company.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        @csrf
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="country" name="country" class="block w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500">

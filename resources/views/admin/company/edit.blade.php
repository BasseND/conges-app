...
<x-app-layout>
    <div class="min-h-screen">
                ...
                <div class="bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl p-6 mb-6">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{{ __('Modifier l\'entreprise') }}</h1>
                            <p class="text-sm sm:text-base text-white mt-1">{{ __('Mettez à jour les informations de votre entreprise') }}</p>
                        </div>
                    </div>
        ...
        <!-- END HEDARE  -->
            ...
            <div class="md:bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                <form action="{{ route('admin.company.update') }}" method="POST" enctype="multipart/form-data" class="md:p-8 space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 border border-blue-200 dark:border-blue-800 rounded-xl p-6 space-y-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="registration_number" name="registration_number" value="{{ old('registration_number', $company->registration_number ?? '') }}" class="block w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500" placeholder="SIRET, RCS, ou autre numéro d'identification">
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="director_name" name="director_name" value="{{ old('director_name', $company->director_name ?? '') }}" class="block w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500" placeholder="Nom complet du directeur">
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="hr_director_name" name="hr_director_name" value="{{ old('hr_director_name', $company->hr_director_name ?? '') }}" class="block w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500" placeholder="Nom complet du DRH">
                                </div>
                        ...
                        <div class="space-y-2">
                            ...
                            @if(isset($company->hr_signature) && $company->hr_signature)
                                <div class="mt-2">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Signature actuelle :</p>
                                    <img src="{{ asset('storage/' . $company->hr_signature) }}" alt="Signature DRH" class="max-w-xs h-auto border border-gray-300 rounded-lg">
                                </div>
                            @endif

<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.departments.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white dark:text-white dark:bg-blue-600 dark:hover:bg-blue-700 font-bold py-2 px-4 rounded">
                Nouveau département
            </a>
        </div>
    </x-slot>
                                ...
                                @forelse($departments as $department)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <button onclick="showDeleteModal('{{ route('admin.departments.destroy', $department) }}')" 

                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('departments.organigramme', $department) }}" 
                           class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg hover:from-purple-600 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 mb-8">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Informations l'Entité</h2>
                    </div>
                ...
                <div class="p-8">
                    ...
                    @else
                        ...
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-6">Cette entité n'a pas encore d'utilisateurs. Commencez par en ajouter un.</p>
                            <a href="{{ route('admin.users.create') }}" 

                ...
                <div class="px-6 py-4">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Nouvelle Entité') }}</h1>
                                <p class="text-gray-600 dark:text-gray-400 mt-1">Créez un nouvelle Entité pour organiser votre équipe</p>
                            </div>
                        </div>
                        <div class="flex-shrink-0">

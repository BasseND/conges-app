                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.departments.update', $department) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $department->description) }}</textarea>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-primary-button>
                                {{ __('Mettre à jour le département') }}
                            </x-primary-button>
                        </div>
                    </form>
                </div>

...
<x-modal name="edit-personal-info" :show="false"  class="sm:w-full sm:max-w-2xl sm:mx-auto sm:align-middle">
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                <button type="submit"  class="btn btn-primary tracking-widest">
                    {{ __('Enregistrer') }}
                </button>
                <button type="button" x-on:click="$dispatch('close-modal', 'edit-personal-info')" class="btn btn-secondary tracking-widest">
                    {{ __('Annuler') }}
                </button> 
            </div>

        ...
        <div class="max-w-7xl mx-auto mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <div class="text-center">
                <div class="flex justify-center">
                  <img src="{{ asset('images/illustration/404.svg') }}" class="block w-auto h-52 mb-4" alt="Image 404">
                </div>
                <h1 class="text-2xl font-semibold text-gray-900 mb-2">Page introuvable</h1>

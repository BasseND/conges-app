                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100" id="modal-title">
                            Confirmer le rejet de l'avance sur salaire
                        </h3>
                        <div class="mt-2">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="rejection_reason" name="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" placeholder="Veuillez expliquer la raison du rejet de cette avance sur salaire"></textarea>
                            </div>
                        </div>
                    </div>
                </div>

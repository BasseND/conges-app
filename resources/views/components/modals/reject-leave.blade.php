...
<div x-data="{ show: false, url: '', method: 'POST' }" 
     x-show="show" 
     @reject-leave.window="show = true; url = $event.detail; method = 'POST'"
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="rejection_reason" name="rejection_reason" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" placeholder="Veuillez expliquer la raison du rejet"></textarea>
                            </div>
                        </div>
                    </div>
                </div>

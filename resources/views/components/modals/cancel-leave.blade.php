...
<div x-data="{ show: false, url: '', method: 'POST' }"
     x-show="show"
     @cancel-leave.window="show = true; url = $event.detail; method = 'POST'"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="show"
            ...
            <form x-bind:action="url" x-bind:method="method" class="w-full">
                @csrf
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="mt-4">
                                <label for="cancellation_reason" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Motif d'annulation
                                </label>
                                <textarea id="cancellation_reason" name="cancellation_reason" rows="3" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" placeholder="Veuillez indiquer le motif de l'annulation..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
